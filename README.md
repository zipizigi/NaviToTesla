...
읽는 범위, 저장 정보, 주소 조회, 해제 방법은 [접근성 기능 사용 안내](ACCESSIBILITY.md)에 정리해 두었다.
앱에서 접근성 기능을 켜기 전에 같은 내용의 동의 화면이 표시된다.
...
변환된 주소를 차량 내비게이션에서 검색할 수 있는지 확인하기 위해 Google Places API도 호출한다.
